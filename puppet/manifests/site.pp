# https://ask.puppetlabs.com/question/6640/warning-the-package-types-allow_virtual-parameter-will-be-changing-its-default-value-from-false-to-true-in-a-future-release/?answer=9525#post-id-9525
...
node default {
  ...
  # The following isn't working. The closest so far is
  # https://github.com/jfryman/puppet-nginx/blob/master/docs/hiera.md:
  # class { 'nginx::config':
  #  sendfile => 'off',
  # }
  # which only 'redeclares' nginx::config, so currently manually editing
